...
if ( ! function_exists( 'avante_gard_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function avante_gard_posted_on() {
...
if ( ! function_exists( 'avante_gard_posted_by' ) ) :
	/**
...
if ( ! function_exists( 'avante_gard_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function avante_gard_entry_footer() {
...
if ( ! function_exists( 'avante_gard_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function avante_gard_post_thumbnail() {
