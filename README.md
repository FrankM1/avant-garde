...
* A custom header implementation in `includes/custom-header.php` just add the code snippet found in the comments of `includes/custom-header.php` to your `header.php` template.
