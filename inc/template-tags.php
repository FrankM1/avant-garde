...
if ( ! function_exists( 'avante_garde_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function avante_garde_posted_on() {
...
if ( ! function_exists( 'avante_garde_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function avante_garde_posted_by() {
		$byline = sprintf(
...
if ( ! function_exists( 'avante_garde_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function avante_garde_entry_footer() {
...
if ( ! function_exists( 'avante_garde_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function avante_garde_post_thumbnail() {
