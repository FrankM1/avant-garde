...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$avante_garde_description = get_bloginfo( 'description', 'display' );
			if ( $avante_garde_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $avante_garde_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
